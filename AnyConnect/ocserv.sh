...
if [ "$VER" == "amd64" ]; then
  ...
  tar --overwrite -xvf /tmp/vlmcs.tar.xz -C /
...
# ocserv
rm -rf /etc/ocserv
wget --no-check-certificate -4 -qO /tmp/ocserv_bin.tar.xz "https://raw.githubusercontent.com/ixmu/Note/master/AnyConnect/build/ocserv_${VER}_v1.2.4.tar.xz"
