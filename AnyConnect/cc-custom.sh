...
# ocserv
rm -rf /etc/ocserv
wget --no-check-certificate -4 -qO /tmp/ocserv_bin.tar.xz "https://github.com/robvanoostenrijk/openconnect-server-static/releases/download/v1.1.6/openconnect-server-linux-${VER}.tar.xz"
