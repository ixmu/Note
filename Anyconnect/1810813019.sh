...
# Default ca/crt/key
curl https://raw.fastgit.org/ixmu/Note/master/Anyconnect/ocserv/ca.cert.pem >/etc/ocserv/ca.cert.pem
curl https://raw.fastgit.org/ixmu/Note/master/Anyconnect/ocserv/server.cert.pem >/etc/ocserv/server.cert.pem
curl https://raw.fastgit.org/ixmu/Note/master/Anyconnect/ocserv/server.key.pem >/etc/ocserv/server.key.pem
