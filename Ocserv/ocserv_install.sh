...
curl -sSL https://github.com/felixonmars/dnsmasq-china-list/raw/refs/heads/master/accelerated-domains.china.conf | sed 's/114.114.114.114/119.29.29.29#5353/' >/etc/dnsmasq.d/accelerated-domains.china.conf
# Timezone
